    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (contentTitle === "" || industery === "") {
                creatToastAlert({
                    message: "Please enter both content title, industery and your country."
                });
                return;
            }
            setProcessing(true);
                    ...
                    {!successMessage ? (
                        ...
                        <div className="text-center text-gray-800">
                            ...
                            <p className="text-sm text-gray-600 mb-4 font-normal">
                                <span className="font-bold text-gray-800">Note:</span> If your requested content is available, our team will add it as soon as possible. Thank you for your patience!
                            </p>
                            <button
                                onClick={() => {
                                    onClose();
                                ...
                                className="rounded float-right bg-gray-800 hover:bg-gray-900 w-28 h-10 px-2 flex justify-center items-center text-xs font-medium text-gray-50"
                            >
                                Close
                            </button>
                        </div>
