    ...
    return (
        <header className="sticky top-0 z-50 w-full h-auto flex justify-between items-center bg-gray-900 px-3 border-b border-b-cyan-700">
            ...
            <div className="w-auto h-auto flex items-center py-4 mobile:py-2">
                ...
                <div className="px-5 mobile:px-2 text-cyan-500 text-xl mobile:text-base text-center justify-self-center truncate">
                    {title}
                </div>
            </div>
            <Link href="/search" className="text-yellow-500 mr-10 mobile:mr-2 p-1 text-2xl mobile:text-xl">
