...
export default function CategoryGroupSlider() {
  ...
  return (
    ...
    <div className="w-auto h-auto bg-gray-900 flex flex-row items-center overflow-y-scroll gap-3 mobile:gap-2 whitespace-nowrap pt-4 px-2 border-b border-cyan-700 scroll-smooth scrollbar-hidden">
      <>
