...
export default function MoviesUserActionOptions({ movieData }) {
  ...
  return (
    <>
      ...
      <div className="w-auto h-auto mobile:mt-1 mt-4 flex gap-5 mobile:gap-2.5 mobile:justify-around flex-wrap overflow-x-scroll scrollbar-hidden">

        <div onClick={saveInLocalStorage} role="button" title="Save" className="w-auto h-auto flex gap-1 justify-center items-center bg-gray-200 hover:bg-gray-300 py-1 px-3 rounded-2xl">
          {isSaved ? (
        ...
        <div
          ...
          role="button"
          title="Report"
          className="flex gap-1.5 items-center bg-gray-200 hover:bg-gray-300 px-3 py-1 rounded-2xl"
        >
          <svg
...
function Model({ movieData, setIsModelOpen, isOpen }) {
