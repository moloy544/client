        ...
        <>
            <header className="w-full h-auto bg-white">
                <nav className="w-auto h-auto bg-red-800 py-4 px-5 mobile:px-3 mobile:py-2 flex items-center justify-between border-b border-t border-red-600">
                    ...
                    <input onClick={navigateToSearch} className="w-96 h-10 mobile:w-full mobile:h-9 rounded-md mobile:text-sm text-md py-1 px-2 placeholder:text-gray-800 text-black border border-yellow-500 mobile:hidden" type="text" placeholder="Search movies web series" readOnly />
